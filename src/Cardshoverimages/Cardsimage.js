...
import imagesix from '../../src/Assets/paintbrushes-in-paints-2021-08-27-22-17-24-utc.jpg'
          ...
          <div className="flip-card">
            <div className="flip-card-inner">
              <div className="flip-card-front" style={{width:"100",height:"100%"}}>
                <img src={data.title} alt="Avatar" className='flip-card-image' />
                <div className="data-heading-section">{data.heading}</div>
              </div>
              <div className="flip-card-back">
                <div className='data-heading'><b>{data.heading}</b></div>
                <div className='data-content'>{data.contenttwo}</div>
